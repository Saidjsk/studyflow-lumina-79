  ...
  return (
    <Card>
      <CardHeader className="bg-gray-800/50">
        <CardTitle className="text-gray-200">إعدادات الإعلانات</CardTitle>
      </CardHeader>
      <CardContent className="pt-6">
        ...
        {!adsEnabled && (
          <div className="mt-4 p-3 bg-amber-950/30 border border-amber-900 rounded-md flex items-start">
