...
import BankingSection from './economics/BankingSection';
      ...
      <Card className="mb-6">
        <CardHeader className="bg-blue-50 dark:bg-blue-900/20 border-b border-blue-100 dark:border-blue-800">
          <div className="flex items-center">
            ...
            <CardTitle className="text-blue-800 dark:text-blue-300">الوحدة الثالثة: النظام المصرفي</CardTitle>
          </div>
        </CardHeader>
              ...
              <ul className="list-disc list-inside space-y-1 pr-4">
                <li>1. النظام المصرفي
                  <ul className="list-inside pr-5 space-y-1 mt-1">
                    <li>1-1. تعريف النظام المصرفي</li>
                    <li>1-2. أهمية النظام المصرفي</li>
                  </ul>
                </li>
                <li className="mt-2">2. البنوك (المصارف)
                  <ul className="list-inside pr-5 space-y-1 mt-1">
                    <li>2-1. تعريف البنوك</li>
                    <li>2-2. أنواع البنوك</li>
