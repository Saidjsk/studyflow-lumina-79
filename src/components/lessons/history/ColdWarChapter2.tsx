...
const ColdWarChapter2 = () => {
  const { theme } = useTheme();
  
  const pdfUrl = 'https://drive.google.com/file/d/1_dJbbmicklbYhH4ttvZ4y3tleF5_OoH3/view';
      ...
      <Card className={`w-full mb-6 ${
        ...
        <div className={`border-b p-4 ${
          ...
          <h2 className={`text-lg font-semibold ${
            ...
            المبحث الثاني: قيادة العالم بقطبية ثنائية
          </h2>
        </div>
...
export default ColdWarChapter2;
