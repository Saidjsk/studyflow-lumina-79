...
const ColdWarChapter3 = () => {
  const { theme } = useTheme();
  
  const pdfUrl = 'https://drive.google.com/file/d/1a_xFY5pbBsb360G9iSR8aQJdJHA9onc9/view';
      ...
      <Card className={`w-full mb-6 ${
        ...
        <div className={`border-b p-4 ${
          ...
          <h2 className={`text-lg font-semibold ${
            ...
            المبحث الثالث: الأزمات الدولية في ظل الصراع بين المعسكرين
          </h2>
        </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                <h3 className={`text-lg font-medium ${
                  ...
                  الأزمات الدولية في ظل الصراع بين المعسكرين
                </h3>
                <p className={`text-sm ${
...
export default ColdWarChapter3;
