...
const ColdWarChapter4 = () => {
  const { theme } = useTheme();
  
  const pdfUrl = 'https://drive.google.com/file/d/1a_mu0Fpcsly4GEmcm7GDti9lTHrwNXOV/view';
      ...
      <Card className={`w-full mb-6 ${
        ...
        <div className={`border-b p-4 ${
          ...
          <h2 className={`text-lg font-semibold ${
            ...
            المبحث الرابع: مساعي الانفراج الدولي
          </h2>
        </div>
...
export default ColdWarChapter4;
