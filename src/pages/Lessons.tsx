...
export default function Lessons() {
  ...
  const getLessonsForSubject = () => {
    if (subjectId === 'economics') {
      return [
        { id: 'money', title: 'الوحدة الأولى: النقود', description: 'المبادلة، النقود، السوق، الأسعار' },
        { id: 'banks', title: 'الوحدة الثانية: البنوك', description: 'أنواع البنوك، العمليات المصرفية، الإقراض والودائع' },
        { id: 'trade', title: 'الوحدة الثالثة: التجارة الدولية', description: 'مفهوم التجارة الدولية، الميزان التجاري، سياسات التجارة الخارجية' }
      ];
