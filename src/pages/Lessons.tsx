  ...
  const getLessonsForSubject = () => {
    if (subjectId === 'economics') {
      ...
      return [
        ...
        { id: 'cold-war', title: 'الوحدة الرابعة: الحرب الباردة', description: 'الصراع بين المعسكرين الشرقي والغربي - المباحث الأساسية' },
        { id: 'cold-war-detailed', title: 'دروس الحرب الباردة التفصيلية', description: 'المباحث الأربعة للحرب الباردة بالتفصيل مع الملفات' },
